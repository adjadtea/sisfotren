function load_all_js(){
	return Promise.all([
		load.css('<?=base_url('assets/plugins/animate-css/animate.min.css')?>'),
		load.css('<?=base_url('assets/plugins/bootstrap/css/bootstrap.css')?>').then(()=>{
			load.css('<?=base_url('assets/css/style.min.css')?>');
			load.css('<?=base_url('assets/css/themes/all-themes.css')?>');
		}),
		load.css('<?=base_url('assets/plugins/material-icons/material-icons.css')?>'),
		load.css('<?=base_url('assets/plugins/material-design-iconic-font/css/material-design-iconic-font.min.css')?>'),
		...
		load.js('<?=base_url('assets/plugins/jquery/jquery.min.js')?>').then(()=>{
			...
			load.js('<?=base_url('assets/plugins/jquery-countto/jquery.countTo.js')?>');
			load.js('<?=base_url('assets/plugins/jquery-slimscroll/jquery.slimscroll.js')?>');
			load.js('<?=base_url('assets/plugins/jquery-validation/jquery.validate.js')?>');
			load.js('<?=base_url('assets/plugins/jquery-validation/additional-methods.js')?>');
			load.js('<?=base_url('assets/plugins/jquery-validation/localization/messages_id.js')?>');
			
			
			load.js('<?=base_url('assets/plugins/bootstrap/js/bootstrap.js')?>').then(()=>{
				load.css('<?=base_url('assets/plugins/bootstrap-select/css/bootstrap-select.min.css')?>');
				load.js('<?=base_url('assets/plugins/bootstrap-select/js/bootstrap-select.js')?>');
				
				load.css('<?=base_url('assets/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css')?>');
				load.js('<?=base_url('assets/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')?>');
				...
				load.js('<?=base_url('assets/plugins/dropzone/min/dropzone.min.js')?>');
			...
			load.css('<?=base_url('assets/plugins/waves/waves.min.css')?>');
			load.js('<?=base_url('assets/plugins/waves/waves.min.js')?>');
