	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="material-icons">add</i> <span>Edit Data Pendidikan</span></h4>
			</div>
			<div class="modal-body no-padding">
				<form action="<?=site_url($this->router->fetch_class().'/upload/'.$sertifikat_id)?>" id="frmFileUpload" method="post" enctype="multipart/form-data">
