	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="defaultModalLabel">Tambah Data Pasangan</h4>
			</div>
			<div class="modal-body">
				<form class="pform form" id="frmAddAnak" action="<?=site_url($this->router->fetch_class().'/add_pasangan/'.$pegawai_id)?>">
							...
							<div class="body">
								<div class="pf-element pf-full-width form-group form-float">
									...
									<div class="form-line pf-group">
										<input class="pf-field form-control" name="txtNama" id="txtNama" placeholder="Nama">
									</div>
								</div>
								<div class="pf-element pf-full-width form-group form-float">
								...
								<div class="pf-element pf-full-width form-group form-float">
									...
									<div class="form-line pf-group">
										<input class="pf-field form-control" name="txtTmptLahir" id="txtTmptLahir" placeholder="Tempat Lahir">
									</div>
								</div>
								<div class="pf-element pf-full-width form-group form-float">
									<label class="form-label" for="txtTglLahir">Tgl. Lahir</label>
									<div class="form-line pf-group">
										<input class="pf-field form-control" name="txtTglLahir" id="txtTglLahir" placeholder="Tgl. Lahir" value="<?=date('Y-m-d')?>">
									</div>
								</div>
								<div class="pf-element pf-full-width form-group form-float">
									<label class="form-label" for="txtNoSuratNikah">Pekerjaan</label>
									<div class="form-line pf-group">
										<input class="pf-field form-control" name="txtPekerjaan" id="txtPekerjaan" placeholder="Pekerjaan">
									</div>
								</div>
								<div class="pf-element pf-full-width form-group form-float">
									<label class="form-label" for="txtNama">No. BPJS</label>
									<div class="form-line pf-group">
										<input class="pf-field form-control" name="txtNoBpjs" id="txtNoBpjs" placeholder="No. BPJS">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							<div class="body">
								<div class="pf-element pf-full-width form-group form-float">
									...
									<div class="form-line pf-group">
										<input class="pf-field form-control" name="txtNoSuratNikah" id="txtNoSuratNikah" placeholder="No. Surat Nikah">
									</div>
								</div>
								<div class="pf-element pf-full-width form-group form-float">
									<label class="form-label" for="txtTglNikah">Tgl. Nikah</label>
									<div class="form-line pf-group">
										<input class="pf-field form-control" name="txtTglNikah" id="txtTglNikah" placeholder="Tgl. Nikah" value="<?=date('Y-m-d')?>">
									</div>
								</div>
								<div class="pf-element pf-full-width form-group form-float">
									<label class="form-label" for="txtNama">Status Nikah</label>
									<div class="pf-group" style="width:100%;">
										<input type="radio" class="with-gap radio-col-teal" name="rdSN" id="rdSN01" value="1" checked>
										<label for="rdSN01">Pasangan Saat Ini</label>
										<input type="radio" class="with-gap radio-col-orange" name="rdSN" id="rdSN02" value="2">
										<label for="rdSN02">Cerai</label>
										<input type="radio" class="with-gap radio-col-red" name="rdSN" id="rdSN03" value="3">
