	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="defaultModalLabel">Tambah Data Anak</h4>
			</div>
			<div class="modal-body">
				<form class="pform form" id="frmAddAnak" action="<?=site_url($this->router->fetch_class().'/add_anak/'.$pegawai_id)?>">
